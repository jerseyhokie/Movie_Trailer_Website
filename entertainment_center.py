...
# Bird Cage Movie: title, storyline, poster, movie trailer, and rating
bird_cage = media.Movie(
    "The Bird Cage",
...
# Star Wars Movie: title, storyline, poster, movie trailer, and rating
...
# The Matrix Movie: title, storyline, poster, movie trailer, and rating
...
# The Fifth Element Movie: title, storyline, poster, movie trailer, and rating
...
# Too Wong Foo Movie: title, storyline, poster image, movie trailer, and rating
too_wong_foo = media.Movie(
...
# Build the list of movies within an array
movies = [avatar, bird_cage, star_wars,
          the_matrix, the_fifth_element, too_wong_foo]
